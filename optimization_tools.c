...
double gradient_descent(double input, double target_output, double learning_rate, int num_iterations)
{
    ...
    for (int i = 0; i < num_iterations; i++)
    {
        ...
        // Backpropagation, it computes the gradients of the loss function with respect to the parameters, enabling the model to learn from 
        //the training data and improve its predictions over time
